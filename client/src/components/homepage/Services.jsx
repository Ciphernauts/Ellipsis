...
export default function Services() {
  return (
    <div className={styles.servicesContainer}>
      <div className={`${'homepageSectionContainer'} ${styles.services}`}>
        <div className={styles.desc}>
          <h1>Services</h1>
          <p>
            Explore the key features of our system designed to enhance safety
            and streamline monitoring at your construction sites.
          </p>
        </div>
