...
import PejmanLogo from '../../assets/PejmanJouziAndPartners_logo.png';
    ...
    <div className={styles.footer}>
      ...
      <div className={styles.footerItem}>
        ...
        <ul className={styles.quickLinks}>
          ...
          <li className={styles.listItem}>
            <Link to='/safety-trends' className={styles.link}>
              Safety Trends
            </Link>
          </li>
          <li className={styles.listItem}>
      ...
      <div className={`${styles.footerItem} ${styles.footerItemLast}`}>
        <h3>In Collaboration With</h3>
        <a
          href='https://sale.pejmanjouzi.com/en/home/'
          target='_blank'
          className={styles.affiliation}
        >
          <img
            src={PejmanLogo}
            alt='Pejman Jouzi and Partners Logo'
            className={styles.pjLogo}
          />
          Pejman Jouzi and Partners
        </a>
      </div>
    </div>
  );
